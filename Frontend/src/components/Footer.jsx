...
const Footer = () => {
  return (
    <footer className="w-ful bg-blue-900 text-white">
      {/* Main Footer Content */}
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            <h3 className="text-xl font-bold mb-4">Govt Zamindar PG College</h3>
            <p className="text-gray-300 mb-4 max-w-md">
              Committed to excellence in education, research, and community engagement. 
              Our faculty members are dedicated to nurturing the next generation of leaders.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/faculty" className="text-gray-300 hover:text-white transition">Faculty & Departments</a></li>
              <li><a href="/academics" className="text-gray-300 hover:text-white transition">Academics</a></li>
              <li><a href="/research" className="text-gray-300 hover:text-white transition">Research</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-300">info@university.edu</span>
              </li>
            </ul>
          </div>
        </div>
